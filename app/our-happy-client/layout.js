...
function layout({ children }) {
  return (
    <>
      <head>
        <title>Our Happy Clients || SPRCBD Manipulation Therapy</title>
        <meta
          name="description"
        ...
        <meta
          property="og:title"
          content="Our Happy Clients || SPRCBD Manipulation Therapy"
        />
        <meta
        ...
        />
        <meta property="og:url" content="https://sprcbd.com/our-happy-client" />
