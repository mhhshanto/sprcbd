...
function layout({ children }) {
  return (
    <>
    <head>
      <title>Machineries || SPRCBD Manipulation Therapy</title>
      <meta
        name="description"
      ...
      <meta
        property="og:title"
        content="Machineries || SPRCBD Manipulation Therapy"
      />
      <meta
      ...
      />
      <meta property="og:url" content="https://sprcbd.com/machineries" />
