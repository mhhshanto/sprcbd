...
function layout({ children }) {
  return (
    <>
      <head>
        <title>Get Appointment || SPRCBD Manipulation Therapy</title>
        <meta
          name="description"
        ...
        <meta
          property="og:title"
          content="Get Appointment || SPRCBD Manipulation Therapy"
        />
        <meta
        ...
        />
        <meta property="og:url" content="https://sprcbd.com/appointment" />
