...
function layout({ children }) {
  return (
    <>
      <head>
        <title>Social Links || SPRCBD Manipulation Therapy</title>
        <meta
          name="description"
        ...
        <meta
          property="og:title"
          content="Social Links || SPRCBD Manipulation Therapy"
        />
        <meta
        ...
        />
        <meta property="og:url" content="https://sprcbd.com/sociallinks" />
