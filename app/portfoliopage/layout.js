...
function layout({ children }) {
  return (
    <>
      <head>
        <title>Portfolio || SPRCBD Manipulation Therapy</title>
        <meta
          name="description"
        ...
        <meta
          property="og:title"
          content="Portfolio || SPRCBD Manipulation Therapy"
        />
        <meta
        ...
        />
        <meta property="og:url" content="https://sprcbd.com/portfoliopage" />
